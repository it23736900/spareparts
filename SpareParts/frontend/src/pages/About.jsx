      ...
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <section>
          ...
          <ul className="grid sm:grid-cols-2 gap-4 text-gray-300">
            ...
            <li><span className="text-yellow-400 font-semibold">Genuine Quality:</span> Only authentic European auto parts imported.</li>
            <li><span className="text-yellow-400 font-semibold">Fast Service:</span> Reliable island-wide delivery and quick response.</li>
            <li><span className="text-yellow-400 font-semibold">Global Reach:</span> Direct partnerships across the UK automotive market.</li>
          </ul>
        </section>
